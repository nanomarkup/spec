...
| COMMENT-WRITER | A data-tree writer should emit no comments. | Writer protocol source inspection and implementation review. |
...
| PARSE-SYNTAX | Section 10.4 recognition order and exact forms are observed. | Mapping/sequence fixtures, `mapping_scalar_markers`, `near_markers_sequence`, all separator/near-header/empty-marker invalid fixtures. |
