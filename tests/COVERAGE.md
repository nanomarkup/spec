...
| Raw strings | Ordinary root and nested text; `#` within mapping values | `root_raw_string`, `root_mapping` | `raw_leading_space`, `raw_trailing_space`, `root_raw_trailing_space`, `empty_after_separator` |
...
| Multiline strings | Root and nested empty blocks, leading/internal/trailing blanks, extra indentation, reserved text, LF normalization | `root_multiline_string`, `root_empty_multiline_string`, `multiline_comments`, `multiline_indentation`, `multiline_edges`, `multiline_line_endings` | `multiline_partial_indent`, `root_multiline_sibling` |
