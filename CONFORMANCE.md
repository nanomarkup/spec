...
against the `0.3-draft` fixture corpus. It is language-neutral test
...
The 0.3-draft defines this contract but does not ship a decoder, runner, or CI
...
order is ignored when results are compared.
